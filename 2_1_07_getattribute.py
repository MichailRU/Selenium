...
Возможные возвращаемые значения:
  ...
  'true' (строка) - если атрибут присутствует, но у него значение не указано явно (например, checked)
  'false' (строка) - если атрибут в элементе указан без значения (например, checked='')
'''
